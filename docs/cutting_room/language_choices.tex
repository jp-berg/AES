...
\item
  ...
  a compiler-flag that enables tailoring the binary to the features of the underlying \ac{CPU},
...
\item
  ...
  which means Python is not able to target \ac{CPU} architectures or
