...
\newcommand{\thesistitle}{The Full Title of your Thesis}		%
\day=00 \month=00 \year=2019									%
																%
% Set thesis type and language									%
\newcommand{\thtype}{Bachelor}	% Bachelor, Master or Seminar	%
...
\chapter{Documentation - Encryption} \label{chap:docenc}
\input{documentation_enc}
